...
class ProfileHeader: UICollectionReusableView {
    ...
    private let bioLabel : UILabel = {
        ...
        label.text = "This is a user bio that will span mpre than one line"
        return label
    }()
    ...
    override init(frame: CGRect) {
        ...
        containerView.anchor(top:topAnchor , left :leftAnchor , right: rightAnchor , height: 110)
    ...
    func configure() {
        ...
        editProfileFollowButton.setTitle(viewModel.actionButtonString, for: .normal)
